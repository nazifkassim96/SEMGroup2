...
<p style="color: #4682B4;text-align:center;font-size:50px">Reset Password</p>
<br />
<br />
<br />
<br />
...
<form>
  <label style="color:black; for="Email Address">Email Address*</label>
  <input type="text" id="Email" name="Email">
  <p style="padding: 0px 100px;color:black">Your new password will be send to your email</p>
